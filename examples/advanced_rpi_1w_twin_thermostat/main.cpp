 ...
 * with relays.
 *
 * This example shows a hvac device used for a twin heater system. The system
 * consists of a floor heating system and is heated via a valve getting heat from
 * a solar/heat pump system plus an electric boiler. The electric boiler is used
 * in case the solar/heat pump system is not able to keep the temperature high enough.
 *
